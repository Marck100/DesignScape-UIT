...
export const templates: Record<string, TemplateData> = {
    "portfolio": {
        ...
        elements: [
            // Main title header
            { x: 400, y: 80, width: 200, height: 50, type: "text", content: "Portfolio", fontSize: 28, fontBold: true, textAlign: "center" },
            
            // Project Alpha section
            { x: 80, y: 160, width: 180, height: 30, type: "text", content: "Project Alpha", fontSize: 16, fontBold: true },
            ...
            { x: 320, y: 160, width: 180, height: 30, type: "text", content: "Project Beta", fontSize: 16, fontBold: true },
            ...
            { x: 560, y: 160, width: 180, height: 30, type: "text", content: "Project Gamma", fontSize: 16, fontBold: true },
            ...
            { x: 800, y: 160, width: 180, height: 30, type: "text", content: "Project Delta", fontSize: 16, fontBold: true },
    ...
    "magazine": {
        ...
        elements: [
            // Title
            { x: 50, y: 50, width: 900, height: 80, type: "text", content: "DESIGN MAGAZINE", fontSize: 48, fontBold: true, textAlign: "center" },
            ...
            // Background box
            { x: 670, y: 140, width: 300, height: 370, type: "box", content: "", fillColor: "#f8fafc" },
            
            // Text (on the right)
            { x: 690, y: 160, width: 260, height: 180, type: "text", content: "Creative Design Trends\n\nExploring the latest innovations in visual design and user experience. This article covers emerging techniques and methodologies.", fontSize: 16, fontBold: true },
